    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav mx-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link <?php echo strpos($_SERVER['SCRIPT_NAME'], '/products/') !== false ? 'active' : ''; ?>" 
                       href="<?php echo SITE_URL; ?>/pages/products/">
                        <i class="bi bi-bag me-1"></i> Shop
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?php echo strpos($_SERVER['SCRIPT_NAME'], '/tailor/browse') !== false ? 'active' : ''; ?>" 
                       href="<?php echo SITE_URL; ?>/pages/tailor/browse.php">
                        <i class="bi bi-person-badge me-1"></i> Find Tailors
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?php echo strpos($_SERVER['SCRIPT_NAME'], '/how-it-works') !== false ? 'active' : ''; ?>" 
                       href="<?php echo SITE_URL; ?>/pages/how-it-works.php">
                        <i class="bi bi-question-circle me-1"></i> How It Works
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?php echo strpos($_SERVER['SCRIPT_NAME'], '/contact') !== false ? 'active' : ''; ?>" 
            ...
            <div class="d-flex align-items-center">
                <!-- Search Form -->
                <form action="<?php echo SITE_URL; ?>/pages/products/" method="GET" class="me-3" style="max-width: 300px;">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        ...
                        <li><a class="dropdown-item" href="<?php echo SITE_URL; ?>/pages/messages.php">
